...
5) К проекту подключен Allure для генерации и просмотра отчетов по тестам (подробные отчеты с шагами воспроизведения и с вложениями с тестовыми данными, запросом и ответом).
